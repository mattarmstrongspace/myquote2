class ApplicationController < ActionController::Base
  ...
  #current user method retreivesdetails of logged in user from session opject, assigning details to @current_user, so database is only queried once per requested
  def current_user
