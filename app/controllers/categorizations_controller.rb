class CategorizationsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @categorization.update(categorization_params)
        format.html { redirect_to @categorization, notice: "Categorization was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to categorizations_path, notice: "Categorization was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def categorization_params
      params.expect(categorization: [ :quote_id, :category_id ])
    end
end
